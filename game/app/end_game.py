...
def Main(screen, res):
    ...
    yes_button = Button((300, 100), 'YES (BONUS)', font)

    no_button = Button((300, 100), 'NO (ENDLESS)', font)
    ...
    gun_text = score_font.render('YOU BEAT THE FINAL BOSS. END SHIFT NOW?', True, (255, 255, 255))
